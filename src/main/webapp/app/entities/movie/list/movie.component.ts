...
export class MovieComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.movies = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IMovie[] | null): IMovie[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.movieService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
